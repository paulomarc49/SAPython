...
def centrar_ventana(ventana):
    ...
    ventana.update_idletasks()  # Actualiza medidas internas
...
class MenuApp:
    def __init__(self, root):
        ...
        botones = [
            ...
            ("ℹ️ Acerca de", self.abrir_acerca_de),
            ("🚪 Salir", self.cerrar_app),
        ]
    ...
    def cerrar_app(self):
        """Cierra TODA la aplicación de forma limpia."""
        self.root.destroy()
    ...
    def abrir_plan(self):
        ...
        centrar_ventana(ventana)  # 👈 centrar ventana hija
    ...
    def abrir_acerca_de(self):
        ...
        centrar_ventana(ventana)  # 👈 centrar ventana "Acerca de"


if __name__ == "__main__":
    root = tk.Tk()
    app = MenuApp(root)
    centrar_ventana(root)   # 👈 centrar el menú principal
    root.mainloop()
